export const emailCases = [
  {
    ...
    body: `We noticed an unusual sign-in attempt from a new device. Please verify your account to prevent unauthorized access.`,
    links: [{ text: "Review Activity", href: "http://microsoft-account-authentication.com" }],
    solution: "Phishing",
    explanation: "El dominio imita a Microsoft, pero es falso. Microsoft solo usa microsoft.com."
  },
  {
    id: 2,
    ...
    body: `You've won an iPhone! Claim it now before the 24-hour window closes.`,
    links: [{ text: "Claim Now", href: "http://free-iphone-claim.com" }],
    solution: "Phishing",
    explanation: "Ofertas gratuitas con límite de tiempo suelen ser phishing."
  },
  {
    id: 3,
